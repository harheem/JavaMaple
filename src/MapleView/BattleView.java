...
public class BattleView extends JFrame implements Runnable { // View에선 버튼의 생성과 추가 및 Location 설정. Button에서 버튼의 사이즈 및 아이콘
	...
	//컴포넌트 위치설정
		public void cpnsSetLocation() {
			...
			this.timer.setLocation(570, 250); //타이머
			...
			this.w1.setLocation(180, 600); //플레이어 무기
			this.w2.setLocation(870, 600); //enemy 무기
			
			this.pHp.setLocation(260, 600); // 플레이어 hp프로그레스바
			this.pMp.setLocation(260, 650); // 플레이어 mp프로그레스바
			this.eHp.setLocation(950, 600); // 에너미 hp프로그레스바
			this.eMp.setLocation(950, 650); // 에너미 mp프로그레스바
			...
			this.pm.setLocation(460, 650); //플레이어 mp상태보이기
			this.eh.setLocation(1150, 600); //enemy hp상태보이기
			this.em.setLocation(1150, 650); //enemy mp상태보이기
	...
	public int getTime() {return this.time;} //타이머 시간 return 나중에 기록으로 쓰시려면 Control에서 배틀뷰 닫을때 타임을 받아가면 될 것 같습니다!
}
