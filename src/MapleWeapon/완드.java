...
public class 완드 extends Weapon {
	...
	public 완드() {
		...
		skillEffect.add("../image/skilleffect/FireSkill1Effect.png");
		skillEffect.add("../image/skilleffect/FireSkill2Effect.png");
		skillEffect.add("../image/skilleffect_e/FireSkill1Effect.png");
		skillEffect.add("../image/skilleffect_e/FireSkill2Effect.png");
